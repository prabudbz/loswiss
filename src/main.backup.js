  ...
  <header class="fixed top-0 w-full z-50 transition-all duration-500 bg-transparent border-b border-transparent" id="main-header">
     <div class="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
       <a href="/index.html" class="flex flex-col group z-50 relative inline-flex items-center">
         ...
         <span class="text-[0.82rem] text-white font-serif font-bold uppercase tracking-[0.2em] opacity-95 group-hover:opacity-100 transition-opacity mt-1.5 text-center w-full">Small Finance Bank</span>
       </a>
...
const footerHTML = `
  <footer class="bg-brand-dark text-white border-t border-white/10 py-16">
    <div class="max-w-7xl mx-auto px-6">
      
      <!-- Top Grid: Brand & Tagline + Socials -->
      <div class="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 mb-12">
        <div class="flex flex-col items-center md:items-start text-center md:text-left max-w-md">
          <a href="/index.html" class="flex flex-col group inline-flex items-center md:items-start mb-4">
            <span class="text-4xl font-['Oswald'] text-white tracking-[0.02em] font-medium leading-none mb-1 group-hover:text-brand-accent transition-colors scale-y-110 origin-bottom">LOSWISS</span>
            <span class="text-[0.72rem] text-white font-serif font-bold uppercase tracking-[0.18em] opacity-95 mt-1">Small Finance Bank</span>
          </a>
        ...
        <div class="flex space-x-4">
          ...
          <a href="#" aria-label="Twitter" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-brand-accent hover:border-brand-accent transition-all duration-300 text-white hover:scale-105">
      ...
      <div class="border-t border-white/10 py-6 text-center md:text-left">
      ...
      <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-[0.7rem] text-gray-400 font-sans tracking-widest gap-4">
        <span>&copy; ${new Date().getFullYear()} LOSWISS. ALL RIGHTS RESERVED.</span>
        <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 uppercase">
...
function initGlobalUI() {
  ...
  if (themeToggle) {
    ...
    themeToggle.addEventListener('click', () => {
      ...
      if (document.documentElement.classList.contains('theme-gold')) {
